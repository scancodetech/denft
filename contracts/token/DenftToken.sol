...
contract denft is ERC20Burnable, Operator {
	uint256 private constant MAX_SUPPLY = 100000000e18;

	
    constructor() public ERC20('DeNFT Coin', 'DeNFT') {
     ...
     * @param _amount The amount of basis cash to mint to
     */
    function mint(address  _to, uint256 _amount)
        ...
        returns (bool)
    {
		require(totalSupply().add(_amount) <= MAX_SUPPLY, "cap exceeded");
